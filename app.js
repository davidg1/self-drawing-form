...
app.post('/contact-us', (req, res) => {
  ...
  // When using the mysql package you do not need to implement tasks in nested
  // callbacks because all methods on the connection object are queued.
  ...
  res.render('confirmation', {
    ...
    addToMailingList, // ES6 enhanced object literal syntax
